...
namespace Veterinary_App_Semos.Controllers
{
    public class PetsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PetId,Name,Age,OwnerId")] Pet pet)
        {
            ...
            {
                pet.Vaccines = _context.Vaccines.Where(x => pet.VaccinesNames.Contains(x.VaccineId)).ToList();
            ...
            ViewData["OwnerId"] = new SelectList(_context.Set<Owner>(), "OwnerId", "Name", pet.OwnerId);
            ViewData["VaccineId"] = new MultiSelectList(_context.Vaccines, "VaccineId", "Name", pet.VaccinesNames);
            return View(pet);
        }
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    existingPet.Vaccines = _context.Vaccines
                        .Where(v => pet.VaccinesNames.Contains(v.VaccineId))
                        .ToList();
